...
{
    public partial class FormSisaStok : Form
    {
        public string token { get; set; }
        private string url = "https://api1.thekingcorp.org/sisaStock/report/";
        ...
        private void btnPilih_Click(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Process.Start(@"F:\LaporanSisaStok.pdf");
        ...
        static async Task<String> GetURI(Uri u, string token)
        {
            using (var client = new HttpClient())
            {
                ...
                try
                {
                    ...
                    using (var file = System.IO.File.Create(@"F:\LaporanSisaStok.pdf"))
