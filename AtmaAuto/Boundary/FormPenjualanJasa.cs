...
{
    public partial class FormPenjualanJasa : Form
    {
        public string token { get; set; }
        private string url = "https://api1.thekingcorp.org/penjualanJasa/report/";

        public FormPenjualanJasa()
        {
            InitializeComponent();
        }
        ...
        private void btnPilih_Click(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Process.Start(@"F:\LaporanPenjualanJasa.pdf");
            MessageBox.Show("Data Laporan Sisa Stok Berhasil Di Download", "SELAMAT", MessageBoxButtons.OK);
        ...
        static async Task<String> GetURI(Uri u, string token)
        {
            using (var client = new HttpClient())
            {
                ...
                try
                {
                    ...
                    using (var file = System.IO.File.Create(@"F:\LaporanPenjualanJasa.pdf"))
