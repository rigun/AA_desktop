...
namespace AtmaAuto.Boundary
{
    public partial class FormLaporanPendapatanBulanan : Form
    {
        ...
        private string url = "https://api1.thekingcorp.org/pendapatanbulanan/report/";

        public FormLaporanPendapatanBulanan()
        {
            InitializeComponent();
        }
        ...
        private void btnPilih_Click(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Process.Start(@"F:\LapTerlaris19.pdf");
        ...
        static async Task<String> GetURI(Uri u, string token)
        {
            using (var client = new HttpClient())
            {
                ...
                try
                {
                    ...
                    using (var file = System.IO.File.Create(@"F:\LapTerlaris19.pdf"))
        ...
        private void txttahun_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
